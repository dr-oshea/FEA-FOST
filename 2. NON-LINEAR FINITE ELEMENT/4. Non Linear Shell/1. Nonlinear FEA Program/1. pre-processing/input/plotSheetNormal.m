function plotSheetNormal(input,PND,type)
...
%plotting fibre vectors    
    ...
    sheet_U = input.FIBRES.n(i,1);
    sheet_V = input.FIBRES.n(i,2);
    sheet_W = input.FIBRES.n(i,3);
    quiver3(element_centre_x,element_centre_y,element_centre_z,sheet_U,sheet_V,sheet_W,1.5,'ShowArrowHead','off',Color='k');
