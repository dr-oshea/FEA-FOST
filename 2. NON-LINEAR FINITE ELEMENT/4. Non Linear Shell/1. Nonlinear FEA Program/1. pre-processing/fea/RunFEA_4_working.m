...
CASE = 91;   % choose boundary conditions from previously set-up cases.
...
% Discretisation
meshDivisions = 2;       % element divisions along x-dimension (2D), z-dim (3D)
...
if CASE == 3 || CASE == 91 || CASE == 92 || CASE == 93 || CASE == 94 || CASE == 95 || CASE == 96
