function Ks = Assemble_Tangent_Stiffness(Q,input,type,ndPerElem,dofN,PROG)
...
for i=1:numElem
    ...
    if type == 1
        ...
        K0e = Element_Tangent_Stiffness_2D(q,localCoords,theta,input.model);
    ...
    if type == 2 || type == 4
        ...
        mixed = 0;
        if mixed == 1
            K0e = Element_Tangent_Stiffness_3D_MIXED(q,localCoords,theta,input.model);
        else
            ...
            K0e = Element_Tangent_Stiffness_3D(q,localCoords,theta,input.model,fibres);
        end
